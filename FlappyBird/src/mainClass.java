...
public class mainClass implements ActionListener, KeyListener {
	...
	private static mainClass tc = new mainClass();
	private static PlayScreen pgs; //panel that has the moving background at the start of the game
	...
	private JPanel createContentPane() {
		...
		pgs = new PlayScreen(SCREEN_WIDTH, SCREEN_HEIGHT, true); //true --> we want pgs to be the splash screen
		topPanel.add(pgs);
	...
	private void fadeOperation() {
		Thread t = new Thread() {
			public void run() {
				...
				topPanel.removeAll();
				topPanel.add(temp);
				pgs = new PlayScreen(SCREEN_WIDTH, SCREEN_HEIGHT, false);
